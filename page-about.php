...
<main id="primary" class="site-main">
	...
	<section data-aos="fade-up" class="career-timeline">
		...
		if (have_rows('career_timeline')):
			...
			while (have_rows('career_timeline')):
				the_row();
				?>
				<span class="the-line"></span>
				<div>
					<h2>
						<?php the_sub_field('milestone_title'); ?>
					</h2>
					<?php
	...
	<section data-aos="fade-up" class="more-about-us">
		<div>
			...
			<?php
			$careers_link = get_post_type_archive_link('cac-careers');
			if ($careers_link):

				?>
				<a class='button' href="<?php echo esc_url($careers_link); ?>">
					Work With Us
				</a>
			<?php endif; ?>
		</div>
	...
	<section data-aos="fade-up" class="more-about-us-2">
		<div>
			<h2>
				<?php the_field('sub_heading_2'); ?>
			</h2>
			<p>
				<?php the_field('sub_content_2'); ?>
			</p>
			<?php
